...
NSString *const FLTFirebaseCrashlyticsLibraryName = @"flutter-fire-cls";
NSString *const FLTFirebaseCrashlyticsLibraryVersion = @"3.4.17";
...
- (NSString *_Nonnull)firebaseLibraryName {
  return FLTFirebaseCrashlyticsLibraryName;
}

- (NSString *_Nonnull)firebaseLibraryVersion {
  return FLTFirebaseCrashlyticsLibraryVersion;
}
