...
#import "messages.g.h"
NSString *const FLTFirebaseCoreLibraryName = @"flutter-fire-core";
NSString *const FLTFirebaseCoreLibraryVersion = @"2.26.0";
...
- (NSString *_Nonnull)firebaseLibraryName {
  return FLTFirebaseCoreLibraryName;
}

- (NSString *_Nonnull)firebaseLibraryVersion {
  return FLTFirebaseCoreLibraryVersion;
}
