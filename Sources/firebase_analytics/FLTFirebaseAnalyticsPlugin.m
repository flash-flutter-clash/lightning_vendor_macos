...
NSString *const FLTFirebaseAnalyticsLibraryName = @"flutter-fire-analytics";
NSString *const FLTFirebaseAnalyticsLibraryVersion = @"10.8.8";
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  ...
  if ([FIRApp respondsToSelector:sel]) {
    [FIRApp performSelector:sel withObject:FLTFirebaseAnalyticsLibraryName withObject:FLTFirebaseAnalyticsLibraryVersion];
  }
}
...
- (NSString *_Nonnull)firebaseLibraryName {
  return FLTFirebaseAnalyticsLibraryName;
}

- (NSString *_Nonnull)firebaseLibraryVersion {
  return FLTFirebaseAnalyticsLibraryVersion;
}
